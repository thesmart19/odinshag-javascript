...
$(document).ready(function () {
    ...
    (function ($) {
        ...
        $.fn.FormValidation = function (useAjax, url, ymTarget) {
            ...
            /* обработчики событий */
            object.on("change", "input", function (event) {
    ...
    (function ($) {
        $.fn.orderFormMVC = function () {
            ...
            MVC.View = function (object) {
                ...
                this.objectForm.on("click", function (event) {
                    ...
                    if (typeof targetClass !== "undefined") {
                        ...
                        case "pickupactive":
                            ...
                            $(this).find("#cashless-type option").each(function () {
                ...
                this.objectForm.on("submit", function (event) {
                    ...
                    for (var errType in errors) {
                        ...
                        case "personFIDMissing":
                            ...
                            if (model.orderFormData.paymentType == "cashless" && $(this).find(".bank-transfer").css("display") == "block") {
                ...
                this.showPickupError = function (disablePaymentMethod) {
                    var errors = {};
                    /* onGetOrderFormErrors */
                    ...
                    if ( typeof disablePaymentMethod !== "undefined" && disablePaymentMethod === true ) {
                        ...
                        /*
                            ...
                            if (errors.bankPaymentForPersonOnly === true) {
                                error.text("Банковский перевод быть не доступен для Юр. лиц и индивидуальных предпринимателей.");
                            }
            ...
            MVC.Controller = function (model, view) {
                ...
                function SetCartTotal(isTotalPriceChanged, data) {
                    ...
                    /* console.log(model.orderFormErrors); */
